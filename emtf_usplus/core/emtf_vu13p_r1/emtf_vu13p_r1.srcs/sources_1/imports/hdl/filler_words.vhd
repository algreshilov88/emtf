...
begin
  ...
  -- LHC Clock Multiplier / Clock Ratio
  clk_multiplier <= std_logic_vector(to_unsigned(CLOCK_RATIO, 4));


  -- build payload of filler control words as specified by CSP
  -- Link Id 0 - Type Field (63 : 56) & Index (55 : 52) & Reserved(51 : 32) 
  --  Bits 31-20: zeros (reserved/unused field)
  --  Bits 19-12: crate/subsystem ID
  --  Bits 11-8: slot ID
  --  Bits 7-0: card-level channel ID 
  link_id0_payload_out(55 downto 52) <= index_number;
  link_id0_payload_out(51 downto 32) <= CONTROL_RESERVED;
  link_id0_payload_out(31 downto 20) <= (others => '0');
  link_id0_payload_out(19 downto 12) <= txMetadata_in.crate_id;
  link_id0_payload_out(11 downto 8)  <= txMetadata_in.slot_id;
  link_id0_payload_out(7 downto 0)   <= channel_id;
  
  -- Link Id 1 - Type Field (63 : 56) & Index (55 : 52) & Reserved(51 : 32)
  -- Format 1:
  -- Bits 31-29: "001" (indicating Format 1)
  -- Bits 28-26: zeros (reserved/unused field)
  -- Bit 25: Idle-as-Filler Transmission Flag
  -- Bit 24: Idle Transmission Method
  -- Bits 23-12: Packet Size (Number of data words in the CRC-protected packet)
  -- Bits 11-0: Packet Interval (Number of data words between packet starts including Idles) 
  link_id1_payload_out(55 downto 52) <= index_number;
  link_id1_payload_out(51 downto 32) <= CONTROL_RESERVED;  
  link_id1_payload_out(31 downto 29) <= "001";
  link_id1_payload_out(28 downto 26) <= (others => '0');
  link_id1_payload_out(25)           <= '0'; 
  link_id1_payload_out(24)           <= idle_method_i;
  link_id1_payload_out(23 downto 12) <= txMetadata_in.packet_size(CH);
  link_id1_payload_out(11 downto 0)  <= txMetadata_in.packet_interval(CH);
